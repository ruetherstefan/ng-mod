...
def test_lookupFrei(bilder_mock):
    ...
    bilder_mock().get_image.assert_called_with("Markierungen/Weis/WeicheRechtsMitte.png")
...
def test_lookupFrei_andereMarkierungsant(bilder_mock):
    ...
    bilder_mock().get_image.assert_called_with("Markierungen/Weis/WeicheRechtsUnten.png")
...
def test_lookupFrei_weichenbelegung(bilder_mock):
    ...
    bilder_mock().get_image.assert_called_with("Markierungen/Gelb/WeicheRechtsUnten.png")
