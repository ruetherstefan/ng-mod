...
def gegeben_verwalter_mit_3_besetztmodulen(besetzt1, besetzt2, besetzt3):
    besetzmodul1 = gegeben_besetzmodul(BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS, besetzt1)
    besetzmodul2 = gegeben_besetzmodul(BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS, besetzt2)
    besetzmodul3 = gegeben_besetzmodul(BesetztModulAdresse.B012_HAUPT_G1_MITTE, besetzt3)
...
def test_update_zug_position_keine_veraenderung_zug2_lang():
    ...
    zug = gegeben_zug_mit_vorposition(BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS,
                                      BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS)

    ZugController().update_zug_position(zug, gegeben_fahrstrecke(), verwalter)
    assert BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS == zug.ende
    assert BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS == zug.anfang
...
def test_update_zug_position_keine_veraenderung_zug1_lang():
    ...
    assert BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS == zug.ende
    assert BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS == zug.anfang
...
def test_update_zug_position_keine_veraenderung_zug1_lang_weiter_hinten():
    ...
    zug = gegeben_zug_mit_vorposition(BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS,
                                      BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS)

    ZugController().update_zug_position(zug, gegeben_fahrstrecke(), verwalter)
    assert BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS == zug.ende
    assert BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS == zug.anfang
...
def test_update_zug_position_weiter_gefahren_zug2_zu_3_lang():
    ...
    ZugController().update_zug_position(zug, gegeben_fahrstrecke(), verwalter)
    assert BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS == zug.ende
    assert BesetztModulAdresse.B012_HAUPT_G1_MITTE == zug.anfang
...
def test_update_zug_position_fehlerfall_zug_wieder_da():
    ...
    ZugController().update_zug_position(zug, gegeben_fahrstrecke(), verwalter)
    assert BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS is zug.ende
    assert BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS is zug.anfang
...
def test_update_zug_position_weiter_gefahren_vorherige_strecke_freigeben():
    ...
    verwalter.get(BesetztModulAdresse.B012_HAUPT_G1_MITTE).fahrstrasse = True

    ZugController().update_zug_position(zug, gegeben_fahrstrecke(), verwalter)
    assert verwalter.get(BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS).fahrstrasse is False
    assert verwalter.get(BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS).fahrstrasse is True
    assert verwalter.get(BesetztModulAdresse.B012_HAUPT_G1_MITTE).fahrstrasse is True
...
def test_update_zug_position_nicht_weiter_gefahren_kreuzende_fahrstrasse_nicht_freigeben():
    ...
    ZugController().update_zug_position(zug, gegeben_fahrstrecke(), verwalter)
    assert verwalter.get(BesetztModulAdresse.B001_HAUPT_AUSFAHRT_LINKS).fahrstrasse is True
    assert verwalter.get(BesetztModulAdresse.B011_HAUPT_G1_HALTE_LINKS).fahrstrasse is True
    assert verwalter.get(BesetztModulAdresse.B012_HAUPT_G1_MITTE).fahrstrasse is True
