...
class WeichenControlBote:
    ...
    def __init__(self):
        self.weichen_control: WeichenControl = WeichenControl()
    ...
    def aendere_weichenstellung(self, weichenadresse, weichenstellung):
        ...
        self.weichen_control.turnout_set_for_route(self.weichenadresse_mapping.get(weichenadresse), b'\00',
                                                   self.invertiere_weichenstellung(weichenstellung, weichenadresse))
        self.weichen_control.turnout_free(self.weichenadresse_mapping.get(weichenadresse), b'\00')

    @staticmethod
    def invertiere_weichenstellung(weichenstellung, weichenadresse):
